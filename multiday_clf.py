...
if city!="Select a City":
    ...
    if st.button("GENERATE ITINERARY"):
        ...
        model.setObjective(quicksum(utility_scores[i] * ppoi[i,d] for i in poi_ids for d in days), GRB.MAXIMIZE) 
        ...
        if model.status == GRB.OPTIMAL and model.objVal > 0:
            ...
            for d in days:
                ...
                while current_poi>=0 and steps < max_steps:
                ...
                if current_poi == end_poi:
                    itinerary_html += (
                        ...
                        f"Visiting Time: {visit_times[end_poi]*ppoi[end_poi,d]} min</p>"
                    )
